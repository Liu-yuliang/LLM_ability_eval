from utils.LongBench.metrics import *



TASK_TO_PATH={
    'GSM8k': '/MATH/GSM8k/gsm8k_test.jsonl',
    'HumanEval': '/Code/Humaneval/HumanEval.jsonl',
    'PiQA': '/CommensenseQA/piqa/valid.jsonl',
    'MMLU': '/MMLU/data',
    'LongBench': '/LongBench',
    'LooGLE': '/LooGLE'
